 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: 4-state FSM (IDLE, COIN_INSERTED, ITEM_SELECTED, DISPENSING)
 *              with 3 buttons (Insert Coin, Select Item, Cancel) and 3 LEDs.
 *              Demonstrates state transitions and state-dependent LED control.
 *              
 * State Transition Diagram:
 *   IDLE --(coin)--> COIN_INSERTED --(select)--> ITEM_SELECTED --(auto)--> DISPENSING --> IDLE
 *    ^                                                                                        |
