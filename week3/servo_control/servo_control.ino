 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: Reads potentiometer (A0, 0-1023) and maps to servo angle (0-180 degrees).
 *              Servo position updated continuously. Serial prints current angle.
 *              Button triggers full servo sweep (0→180→0 non-blocking style).
 */
