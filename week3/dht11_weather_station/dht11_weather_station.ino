 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: Reads DHT11 temperature and humidity sensor every 2 seconds.
 *              Outputs to Serial in CSV format (timestamp,temp_C,temp_F,humidity).
 *              LED indicators: Red if temp>35°C or humidity>80%, Green otherwise.
