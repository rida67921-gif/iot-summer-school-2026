 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: 4x4 keypad password entry with 16x2 LCD display.
 *              Enter 4-digit PIN to unlock. Correct PIN: "1234" (configurable).
 *              Green LED on correct entry, red LED + buzzer on incorrect.
 *              3-strike lockout: 10 seconds after 3 failed attempts.
 *              Uses non-blocking millis() timing for lockout (no delay() calls).
 */
