 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: LDR (light-dependent resistor) detects day/night.
 *              PIR (motion sensor) triggers full brightness at night (30s timer).
 *              After 30s of no motion, dims to 20% brightness via PWM.
 *              Fully off during day. All events logged with HH:MM:SS timestamp.
 *              Uses helper function to format millis() into human-readable time.
 */
