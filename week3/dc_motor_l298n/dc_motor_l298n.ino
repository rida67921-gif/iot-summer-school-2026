 ...
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: Controls DC motor speed and direction using L298N H-bridge driver.
 *              Potentiometer (A0) sets speed 0-255 via PWM.
 *              Button 1 toggles Forward/Reverse direction.
 *              Button 2 toggles motor ON/OFF.
 *              Serial outputs: Direction, Speed (%), State (Running/Stopped).
 */
