/*
 * Project: Relay Control with Hysteresis
 * Question: Q27
 * Author: [YOUR NAME]
 * Date: [DATE]
 * Description: Relay controlled by DHT11 temperature with hysteresis.
 *              Relay (simulated by LED) turns ON above 32°C, OFF below 28°C.
 *              Hysteresis prevents relay chatter at boundary temperatures.
 *              Manual override button toggles relay state.
 *              All relay state changes logged with triggering temperature.
